...
public class ScoreServiceJDBC implements ScoreInterface {
    ...
    public void updateScore(Score score) throws ScoreException {
        throw new ScoreException("JDBC method for updating score not implemented yet.");
    }

    @Override
    public List<Score> getScoresByPlayer(String player) throws ScoreException {
        throw new ScoreException("JDBC method for updating score not implemented yet.");
    }
}
